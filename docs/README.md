...
| [Monarch-Native Pending Status](design/monarch-native-pending-status.md) | Draft | Deriving Monarch's native `pending` flag from the `Pending` tag queue; post-sync pass registry (Rogers Bank first) |
