...
**Use the `ship` skill** (`.claude/skills/ship/SKILL.md`) to execute this
workflow. It is the authoritative procedure and records the ruleset constraints
...
the reference; the skill is what to follow.
